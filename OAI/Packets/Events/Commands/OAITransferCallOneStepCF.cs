...
{
    class OAITransferCallOneStepCF : OAIConfirmation
    {
        public const string COMMAND = OAITransferCallOneStep.CMD;

        public OAITransferCallOneStepCF(string[] parts) : base(parts) { }
        public OAITransferCallOneStepCF(byte[] bytes) : base(bytes) { }
